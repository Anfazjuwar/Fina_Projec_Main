...
function ProductDetailsDialogAdmin({ open, setOpen, productDetails }) {
    ...
    <Dialog open={open} onOpenChange={handleDialogClose}>
      <DialogContent className="grid grid-cols-2 gap-8 sm:p-12 max-w-[90vw] sm:max-w-[80vw] lg:max-w-[70vw]">
        <div className="flex flex-col gap-4">
          <div className="overflow-hidden rounded-lg border hover:scale-[2.0] transition-transform duration-300">
            <img
              src={
                selectedImage ||
          ...
          <div className="flex gap-2 overflow-x-auto">
            {Array.isArray(productDetails?.image)
              ? productDetails.image.map((imgUrl, idx) => (
                  <img
                    key={idx}
                    src={imgUrl}
                    alt={`Thumbnail ${idx}`}
...
export default ProductDetailsDialogAdmin;
